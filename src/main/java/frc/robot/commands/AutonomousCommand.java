...
public class AutonomousCommand implements Command {
    ...
    public AutonomousCommand(DiffDriveSubsystem diffDriveSubsystem,  ClimberSubsystem climberSubsystem, IntakeSubsystem intakeSubsystem, ShooterSubsystem shooterSubsystem) {
        this.diffDriveSubsystem = diffDriveSubsystem;
        this.climberSubsystem = climberSubsystem;
        this.intakeSubsystem = intakeSubsystem;
        this.shooterSubsystem = shooterSubsystem;
        this.subsystems = Set.of(this.climberSubsystem, this.diffDriveSubsystem, this.intakeSubsystem, this.shooterSubsystem);
    }
    ...
    public void execute() {
        ...
        diffDriveSubsystem.tankDrive(0.75, 0.75);
